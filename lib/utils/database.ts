...
const DATABASE_NAME = 'NexusCollab-Database';
const _DATABASE_VERSION = 8;

/**
 * NexusCollab Database Instance
 */
class NexusCollabDatabase extends Dexie {
  // Table definitions
...
export const db = new NexusCollabDatabase();
